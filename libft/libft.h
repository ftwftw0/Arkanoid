...
/*   Updated: 2015/04/02 18:19:29 by flagoutt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_triputstr(const char *s1,
								const char *s2,
								const char *s3);
...
void				*ft_memchr(const void *s, int val, size_t n);
...
char				*ft_strnstr(char *str, const char *tofind, size_t n);
...
char				*ft_strtrijoin(char const *s1,
								char const *s2,
								char const *s3);
